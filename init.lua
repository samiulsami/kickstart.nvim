...
-- Map Q to format text
vim.api.nvim_set_keymap("n", "Q", "gq", { noremap = true })
-- Set various indentation and tab settings
...
require("toggleterm").setup({
  size = 15, -- Height of the bottom terminal split
...
require("lualine").setup({
  options = {
    theme = "auto", -- or choose a theme like 'gruvbox' or 'onedark'
...
require("lspconfig").gopls.setup({
  on_attach = function(client, bufnr)
    ...
    -- Keymap for going to definition
    -- Keymap for showing hover documentation
    buf_set_keymap("n", "K", "<cmd>lua vim.lsp.buf.hover()<CR>", opts) -- Show hover info

    buf_set_keymap("n", "<leader>k", "<cmd>lua vim.lsp.buf.hover()<CR>", opts) -- Show hover information
  end,
})
...
-- Use this mapping to go to the quickfix item and close the list
vim.api.nvim_set_keymap("n", "<leader>m", ":cnext<CR>:lua close_quickfix()<CR>", { noremap = true, silent = true })
